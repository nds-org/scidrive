...
public class FilesConstants
{
    ...
    /** HTTP header used by Cloud Files for the containers synchronization URL **/
    public static final String X_CONTAINER_SYNC_TO = "X-Container-Sync-To";
    /** HTTP header used by Cloud Files for the containers synchronization key **/
    public static final String X_CONTAINER_SYNC_KEY = "X-Container-Sync-Key";
